...
# --- CEVAP FONKSİYONU (YEDEK MODELLİ) ---
def can_dede_cevapla(user_prompt, kaynaklar, mod):
    ...
    # --- MODEL SEÇİMİ VE DENEME ---
    genai.configure(api_key=GOOGLE_API_KEY)
    
    # Önce Hızlı Modeli Dene, Olmazsa Eskiye Dön
    ...
    for model_ismi in modeller:
        try:
            ...
            return # Başarıyla bitti, fonksiyondan çık
        except Exception:
            continue # Hata verirse bir sonraki modele geç

    yield "⚠️ Üzgünüm can, şu an Google kapıları kapalı. Birazdan tekrar dene."
